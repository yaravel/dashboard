...
<head>
	...
	<!-- MORRIS CHART STYLES-->
	<link href="{{asset('packages/yaravel/dashboard/admin/js/morris/morris-0.4.3.min.css')}}" rel="stylesheet" />
	<link href="{{asset('assets/summernote/dist/summernote.css')}}" rel="stylesheet" />
	<link href="{{asset('packages/yaravel/dashboard/admin/js/dataTables/dataTables.bootstrap.css')}}" rel="stylesheet" />
	@yield('style')
</head>
<body>
	@yield('contentMaster')
	...
	<script type="text/javascript" src="{{asset('packages/yaravel/dashboard/admin/js/morris/raphael-2.1.0.min.js')}}"></script>

	<script type="text/javascript" src="{{asset('assets/summernote/dist/summernote.js')}}"></script>

	<script type="text/javascript" src="{{asset('packages/yaravel/dashboard/admin/js/dataTables/jquery.dataTables.js')}}"></script>
	<script type="text/javascript" src="{{asset('packages/yaravel/dashboard/admin/js/dataTables/dataTables.bootstrap.js')}}"></script>
	{{--<script type="text/javascript" src="{{asset('packages/yaravel/dashboard/admin/js/morris/morris.js')}}"></script>--}}
	<!-- CUSTOM SCRIPTS -->
	<script src="{{asset('packages/yaravel/dashboard/admin/js/custom.js')}}"></script>
